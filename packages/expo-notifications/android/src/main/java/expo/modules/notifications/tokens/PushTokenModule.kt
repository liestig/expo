  ...
  private fun getFirebaseMessagingInstance(promise: Promise): FirebaseMessaging? {
    return try {
      ...
      promise.reject(
        ...
        "Unable to get Firebase Messaging instance. Did you configure `googleServicesFile` path? Make sure to complete the guide at https://docs.expo.dev/push-notifications/fcm-credentials/ : ${e.message}",
        e
      )
      null
    }
